...
//variable is case sensitive 
  ...
  cout << "\n--- Data Types ---" << endl;
  cout << "int age = " << age << endl; //int is data type here
  cout << "float temperature = " << temperature << endl; // float is data type here
  cout << "double height = " << height << endl; // double is data type here
  cout << "char grade = " << grade << endl; // char is data type here
  cout << "bool isStudent = " << isStudent << endl;  //bool is data type here
  cout << "string name = " << name << endl; //string is data type here
